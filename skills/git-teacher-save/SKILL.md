...
description: 변경된 파일을 저장(Commit)하는 스킬. "저장해줘", "커밋", "커밋해줘", "save", "변경 내용 저장", "지금까지 한 거 저장", "세이브" 같은 요청에 사용됩니다.
---
...
뭘 바꿨는지 한 줄로 적어주세요.
예: "로고 이미지 변경", "메인 페이지 디자인 수정"
```

AskUserQuestion 도구를 사용하여 커밋 메시지를 받는다.
