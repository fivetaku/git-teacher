# Disclaimer & Acceptable Use — git-teacher

`git-teacher` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`git-teacher` is a general-purpose developer tool. Like most general-purpose tools, it
